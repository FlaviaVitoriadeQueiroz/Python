...
'''Vantagens:
sempre eficiente, mesmo em listas grandes
estavel
bom para dados grandes e estruturas de dados encadeadas

Desvantagens:
requer memoria adiconal, pois cria sublistas. o espaco adicional precisa ser do mesmo tamanho da lista original
overhead de recursao, pode gerar "stack overflow" em listas muito grandes, pq as chamadas recursivas tem um limite
nao e um algoritmo "in place", ou seja, nao ordena a lista original, mas cria uma nova lista ordenada'''