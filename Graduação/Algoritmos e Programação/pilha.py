""" Operacoes da Pilha:
push para inserir, so insere no topo
pop para remover, so consegue remover oq esta no topo
top para buscar, so consegue ver oq esta no topo

As pilhas podem ser sequenciais ou encadeadas """
