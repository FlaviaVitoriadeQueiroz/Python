...
def somar(numeros):
    if not numeros: #se a lista estiver vazia
        return 0
    return numeros[0] + somar(numeros[1:]) #soma o primeiro elemento da lista com a soma do restante da lista, ate a lista ficar vazia

lista = [18, 9, 12, 21]

print(f"A soma dos elementos da lista {somar(lista)}")

#A recursao tem dois requisitos principais: caso base (condicao de parada) e chamada recursiva (a funcao chama a si mesma com um problema menor)